...
describe('StatsPanel', () => {
    ...
    it('shows Summary tab by default', () => {
        ...
        // Summary tab should be active (blue background)
    ...
    it('switches to Histogram tab on click', () => {
        ...
        expect(histogramTab).toHaveClass('bg-blue-600');
    ...
    it('shows "No specs defined" when no specs provided', () => {
        vi.spyOn(DataContextModule, 'useData').mockReturnValue({
            displayOptions: { showCp: true, showCpk: true },
        } as any);
        ...
        expect(screen.getByText('No specs defined.')).toBeInTheDocument();
    });
