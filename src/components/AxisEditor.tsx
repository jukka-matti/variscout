...
const AxisEditor = ({
    ...
    const [localValueLabels, setLocalValueLabels] = useState<Record<string, string>>({ ...valueLabels });
            ...
            <div className="space-y-3 max-h-60 overflow-y-auto pr-1 custom-scrollbar">
                ...
                {values.length > 0 && (
                    <div className="border-t border-slate-700 pt-2">
                        <label className="text-[10px] text-slate-400 uppercase block mb-1">Category Labels</label>
