...
| Investigation / Findings        | adr-015, adr-020, docs/03-features/workflows/investigation-to-action.md, question-driven-investigation.md, docs/01-vision/eda-mental-model.md, docs/superpowers/specs/2026-03-30-question-driven-eda-design.md, docs/superpowers/specs/2026-04-03-investigation-workspace-reframing-design.md (SuspectedCause hub model) |
...
| --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `packages/core/src/`                          | stats/, parser/, types.ts, tier.ts, ai/, glossary/, variation/, yamazumi/                                                                                                                                       | Stats engine (14 modules), parser, types, tier, AI context, glossary, simulation, yamazumi. `findings/` includes SuspectedCause hub types (`SuspectedCauseEvidence`), factories, helpers, migration. `variation/` includes `findBestSubgroup`, `computeHubEvidence`, `projectWasteElimination`, `projectVAImprovement`, `ProjectionScenario`. Sub-path imports: `@variscout/core/stats`, `/ai`, `/parser`, `/findings`, `/variation`, `/yamazumi`, `/tier`, `/types`, `/i18n`, `/glossary` |
