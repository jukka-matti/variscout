...
| --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `packages/core/src/`                          | stats/, parser/, types.ts, tier.ts, ai/, glossary/, variation/, yamazumi/                                                                                                                                       | Stats engine (14 modules), parser, types, tier, AI context, glossary, simulation, yamazumi. `findings/` includes SuspectedCause hub types and factories. Sub-path imports available: `@variscout/core/stats`, `/ai`, `/parser`, `/findings`, `/variation`, `/yamazumi`, `/tier`, `/types`, `/i18n`, `/glossary` |
