...
| Investigation / Findings   | adr-015, adr-020, docs/03-features/workflows/investigation-to-action.md, hypothesis-investigation.md, docs/01-vision/eda-mental-model.md, docs/superpowers/specs/2026-03-30-question-driven-eda-design.md                                                                                         |
...
| `packages/hooks/src/`                         | use\*.ts (see .claude/rules/monorepo.md for full list)                                                                                                                | 45+ shared React hooks                                                                                                                                                                                                                             |
| `packages/ui/src/components/`                 | \*/ (see .claude/rules/monorepo.md for full list)                                                                                                                     | 110+ shared UI components                                                                                                                                                                                                                          |
...
| `apps/azure/src/`                             | context/DataContext.tsx, services/{localDb,cloudSync,storage}.ts, auth/, hooks/{useEditor\*,useProjectLoader,useProjectOverview}.ts, features/\*/, lib/appInsights.ts | Azure state, storage (IndexedDB + OneDrive sync), auth, Graph API, Zustand stores, App Insights                                                                                                                                                    |
