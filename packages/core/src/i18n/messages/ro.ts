...
export const ro: MessageCatalog = {
  ...
  'admin.planStandardPrice': '€99/lună',
  'admin.planTeamPrice': '€199/lună',
  'admin.planTeamAIPrice': '€279/lună',
  'admin.planStandardDesc': 'Analiză completă, stocare locală fișiere',
  'admin.planTeamDesc': 'Teams, OneDrive, SharePoint, mobil',
  'admin.planTeamAIDesc': 'Bază de cunoștințe AI, CoScout îmbunătățit',
