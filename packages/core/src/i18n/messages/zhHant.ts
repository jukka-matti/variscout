...
export const zhHant: MessageCatalog = {
  ...
  // Investigation
  'analyze.brief': '調查摘要',
  'analyze.assignedToMe': '指派給我',
  'analyze.pinAsFinding': '釘選為發現',
  'analyze.addObservation': '新增觀察',
  ...
  // Analyze prompt
  'analyze.trackingPrompt': '正在追蹤您的調查 — 開啟調查面板以查看全貌。',
  ...
  // Factor Intelligence
  'fi.title': '因子智慧',
  'fi.ranking': '因子排名（R² 調整後）',
  'fi.layer2': '第 2 層 · 主效應',
  'fi.layer3': '第 3 層 · 因子交互',
  'fi.investigate': '調查 →',
  'fi.notSignificant': '不顯著（p={value}）',
  'fi.explainsSingle': '{factor}單獨解釋了{pct}%的變異。',
  'fi.explainsMultiple': '{factors}共同解釋了{pct}%的變異。',
  'fi.layer2Locked': '第 2 層（主效應）在 R²adj > {threshold}% 時解鎖',
  'fi.layer2Current': ' — 目前 {value}%',
  'fi.layer3Locked': '第 3 層（交互）在 ≥2 個因子顯著時解鎖',
  'fi.layer3Current': ' — 目前 {count} 個顯著',
  'fi.best': '最佳',
  'fi.range': '全距',
  'fi.interactionDetected': '偵測到交互作用：{factorA}的效應取決於{factorB}的水準。',
  'fi.noInteraction': '無顯著交互作用 — 效應近似可加。',
