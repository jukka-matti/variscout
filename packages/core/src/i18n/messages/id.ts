...
export const id: MessageCatalog = {
  ...
  // Investigation
  'analyze.brief': 'Ringkasan Investigasi',
  'analyze.assignedToMe': 'Ditugaskan kepada saya',
  'analyze.pinAsFinding': 'Sematkan sebagai temuan',
  'analyze.addObservation': 'Tambahkan observasi',
  ...
  'fi.ranking': 'Peringkat faktor (R² disesuaikan)',
  'fi.layer2': 'Lapisan 2 · Efek Utama',
  'fi.layer3': 'Lapisan 3 · Interaksi Faktor',
  'fi.investigate': 'Selidiki →',
  'fi.notSignificant': 'tidak signifikan (p={value})',
  'fi.explainsSingle': '{factor} menjelaskan {pct}% variasi secara mandiri.',
  'fi.explainsMultiple': '{factors} bersama menjelaskan {pct}% variasi.',
  'fi.layer2Locked': 'Lapisan 2 (Efek Utama) terbuka saat R²adj > {threshold}%',
  'fi.layer2Current': ' — saat ini {value}%',
  'fi.layer3Locked': 'Lapisan 3 (Interaksi) terbuka saat ≥2 faktor signifikan',
  'fi.layer3Current': ' — saat ini {count} signifikan',
  'fi.best': 'Terbaik',
  'fi.range': 'Rentang',
  'fi.interactionDetected':
    'Interaksi terdeteksi: efek {factorA} bergantung pada tingkat {factorB}.',
  'fi.noInteraction': 'Tidak ada interaksi signifikan — efek kira-kira aditif.',
