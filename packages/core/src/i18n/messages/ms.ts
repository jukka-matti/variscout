...
export const ms: MessageCatalog = {
  ...
  // Investigation
  'analyze.brief': 'Ringkasan Penyiasatan',
  'analyze.assignedToMe': 'Ditugaskan kepada saya',
  'analyze.pinAsFinding': 'Semat sebagai penemuan',
  'analyze.addObservation': 'Tambah pemerhatian',
  ...
  'feature.maxRows': 'Sehingga 250K baris',
  ...
  // Factor Intelligence
  'fi.title': 'Kecerdasan Faktor',
  'fi.ranking': 'Kedudukan faktor (R² diselaraskan)',
  'fi.layer2': 'Lapisan 2 · Kesan Utama',
  'fi.layer3': 'Lapisan 3 · Interaksi Faktor',
  'fi.investigate': 'Siasat →',
  'fi.notSignificant': 'tidak signifikan (p={value})',
  'fi.explainsSingle': '{factor} menerangkan {pct}% variasi secara bersendirian.',
  'fi.explainsMultiple': '{factors} bersama menerangkan {pct}% variasi.',
  'fi.layer2Locked': 'Lapisan 2 (Kesan Utama) dibuka apabila R²adj > {threshold}%',
  'fi.layer2Current': ' — pada masa ini {value}%',
  'fi.layer3Locked': 'Lapisan 3 (Interaksi) dibuka apabila ≥2 faktor signifikan',
  'fi.layer3Current': ' — pada masa ini {count} signifikan',
  'fi.best': 'Terbaik',
  'fi.range': 'Julat',
  'fi.interactionDetected': 'Interaksi dikesan: kesan {factorA} bergantung pada tahap {factorB}.',
  'fi.noInteraction': 'Tiada interaksi signifikan — kesan adalah lebih kurang aditif.',
