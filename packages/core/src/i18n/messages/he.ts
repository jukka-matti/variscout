...
export const he: MessageCatalog = {
  ...
  // Investigation
  'analyze.brief': 'תקציר חקירה',
  'analyze.assignedToMe': 'מוקצה אליי',
  'analyze.question': 'Question',
  'analyze.questions': 'Questions',
  'analyze.pinAsFinding': 'הצמד כממצא',
  'analyze.addObservation': 'הוסף תצפית',
  ...
  // Analyze prompt
  'analyze.trackingPrompt': 'עוקבים אחרי החקירה שלך — פתח את לוח החקירה לראות את התמונה המלאה.',
  ...
  // Factor Intelligence
  'fi.title': 'אינטליגנציית גורמים',
  'fi.ranking': 'דירוג גורמים (R² מתוקנן)',
  'fi.layer2': 'שכבה 2 · אפקטים עיקריים',
  'fi.layer3': 'שכבה 3 · אינטראקציות בין גורמים',
  'fi.investigate': 'חקור →',
  'fi.notSignificant': 'לא מובהק (p={value})',
  'fi.explainsSingle': '{factor} מסביר {pct}% מהשונות לבדו.',
  'fi.explainsMultiple': '{factors} יחד מסבירים {pct}% מהשונות.',
  'fi.layer2Locked': 'שכבה 2 (אפקטים עיקריים) נפתחת כאשר R²adj > {threshold}%',
  'fi.layer2Current': ' — כרגע {value}%',
  'fi.layer3Locked': 'שכבה 3 (אינטראקציות) נפתחת כאשר ≥2 גורמים מובהקים',
  'fi.layer3Current': ' — כרגע {count} מובהקים',
  'fi.best': 'הטוב ביותר',
  'fi.range': 'טווח',
  'fi.interactionDetected': 'אינטראקציה זוהתה: ההשפעה של {factorA} תלויה ברמה של {factorB}.',
  'fi.noInteraction': 'אין אינטראקציה מובהקת — ההשפעות הן בקירוב חיבוריות.',
