...
export const nb: MessageCatalog = {
  ...
  'coach.problem.frame': 'Sett opp dataene dine for å begynne å undersøke problemet.',
  'coach.problem.scout': 'Se etter variasjonsmønstre som kan forklare problemet.',
  'coach.problem.investigate': 'Bygg bevis som knytter faktorer til problemet.',
  'coach.problem.improve': 'Planlegg og gjennomfør forbedringer med PDCA-syklusen.',
  'coach.hypothesis.frame': 'Sett opp dataene dine for å teste hypotesen din.',
  'coach.hypothesis.scout': 'Se etter bevis som støtter eller motbeviser hypotesen din.',
  'coach.hypothesis.investigate': 'Samle statistisk bevis for å bekrefte den mistenkte årsaken.',
  'coach.hypothesis.improve': 'Bekreftet årsak — planlegg korrigerende tiltak via PDCA.',
  'coach.routine.frame': 'Sett opp dataene dine for en rutinemessig prosesskontroll.',
  'coach.routine.scout': 'Søk etter nye signaler, drift eller uventede mønstre.',
  'coach.routine.investigate': 'Et signal ble funnet — bor ned i mulige årsaker.',
  'coach.routine.improve': 'Årsak identifisert — planlegg korrigerende tiltak via PDCA.',
  ...
  'admin.planStandardDesc': 'Full analyse, lokal fillagring',
  'admin.planTeamDesc': 'Teams, OneDrive, SharePoint, mobil',
  'admin.planTeamAIDesc': 'AI-kunnskapsbase, forbedret CoScout',
