...
export const nb: MessageCatalog = {
  ...
  'fi.ranking': 'Faktorrangering (R² justert)',
  'fi.layer2': 'Lag 2 · Hovedeffekter',
  'fi.layer3': 'Lag 3 · Faktorinteraksjoner',
  'fi.investigate': 'Undersøk →',
  'fi.notSignificant': 'ikke signifikant (p={value})',
  'fi.explainsSingle': '{factor} forklarer {pct}% av variasjonen alene.',
  'fi.explainsMultiple': '{factors} forklarer sammen {pct}% av variasjonen.',
  'fi.layer2Locked': 'Lag 2 (Hovedeffekter) låses opp når R²adj > {threshold}%',
  'fi.layer2Current': ' — for øyeblikket {value}%',
  'fi.layer3Locked': 'Lag 3 (Interaksjoner) låses opp når ≥2 faktorer er signifikante',
  'fi.layer3Current': ' — for øyeblikket {count} signifikante',
  'fi.best': 'Best',
  'fi.range': 'Variasjonsbredde',
  'fi.interactionDetected': 'Interaksjon oppdaget: {factorA}s effekt avhenger av {factorB}s nivå.',
  'fi.noInteraction': 'Ingen signifikant interaksjon — effektene er tilnærmet additive.',
