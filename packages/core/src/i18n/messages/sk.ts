...
export const sk: MessageCatalog = {
  ...
  // Investigation
  'analyze.brief': 'Súhrn vyšetrovania',
  'analyze.assignedToMe': 'Pridelené mne',
  'analyze.pinAsFinding': 'Pripnúť ako zistenie',
  'analyze.addObservation': 'Pridať pozorovanie',
  ...
  // Factor Intelligence
  'fi.title': 'Inteligencia faktorov',
  'fi.ranking': 'Poradie faktorov (R² upravené)',
  'fi.layer2': 'Vrstva 2 · Hlavné efekty',
  'fi.layer3': 'Vrstva 3 · Interakcie faktorov',
  'fi.investigate': 'Preskúmať →',
  'fi.notSignificant': 'nevýznamné (p={value})',
  'fi.explainsSingle': '{factor} vysvetľuje {pct}% variability samostatne.',
  'fi.explainsMultiple': '{factors} spoločne vysvetľujú {pct}% variability.',
  'fi.layer2Locked': 'Vrstva 2 (Hlavné efekty) sa odomkne pri R²adj > {threshold}%',
  'fi.layer2Current': ' — aktuálne {value}%',
  'fi.layer3Locked': 'Vrstva 3 (Interakcie) sa odomkne pri ≥2 významných faktoroch',
  'fi.layer3Current': ' — aktuálne {count} významných',
  'fi.best': 'Najlepší',
  'fi.range': 'Rozpätie',
  'fi.interactionDetected': 'Zistená interakcia: efekt {factorA} závisí od úrovne {factorB}.',
  'fi.noInteraction': 'Žiadna významná interakcia — efekty sú približne aditívne.',
