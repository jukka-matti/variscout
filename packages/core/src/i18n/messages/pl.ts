...
export const pl: MessageCatalog = {
  ...
  'admin.planStandardPrice': '€99/mies.',
  'admin.planTeamPrice': '€199/mies.',
  'admin.planTeamAIPrice': '€279/mies.',
  'admin.planStandardDesc': 'Pełna analiza, lokalne przechowywanie plików',
  'admin.planTeamDesc': 'Teams, OneDrive, SharePoint, mobilny',
  'admin.planTeamAIDesc': 'AI Knowledge Base, ulepszony CoScout',
