...
export const pl: MessageCatalog = {
  ...
  'display.density': 'Gęstość wyświetlania',
  'display.lockYAxis': 'Zablokuj oś Y',
  'display.filterContext': 'Kontekst filtra',
  'display.showSpecs': 'Pokaż specyfikacje',

  // Investigation
  'analyze.brief': 'Podsumowanie badania',
  'analyze.assignedToMe': 'Przypisane do mnie',
  'analyze.pinAsFinding': 'Przypnij jako ustalenie',
  'analyze.addObservation': 'Dodaj obserwację',
  ...
  // Analyze prompt
  'analyze.trackingPrompt': 'Śledzenie badania — otwórz panel Badanie, aby zobaczyć pełny obraz.',
  ...
  'feature.maxRows': 'Do 250 tys. wierszy',
  ...
  // Factor Intelligence
  'fi.title': 'Inteligencja Czynników',
  'fi.ranking': 'Ranking czynników (R² skorygowane)',
  'fi.layer2': 'Warstwa 2 · Efekty Główne',
  'fi.layer3': 'Warstwa 3 · Interakcje Czynników',
  'fi.investigate': 'Zbadaj →',
  'fi.notSignificant': 'nieistotne (p={value})',
  'fi.explainsSingle': '{factor} wyjaśnia {pct}% zmienności samodzielnie.',
  'fi.explainsMultiple': '{factors} razem wyjaśniają {pct}% zmienności.',
  'fi.layer2Locked': 'Warstwa 2 (Efekty Główne) odblokowuje się gdy R²adj > {threshold}%',
  'fi.layer2Current': ' — obecnie {value}%',
  'fi.layer3Locked': 'Warstwa 3 (Interakcje) odblokowuje się gdy ≥2 czynniki są istotne',
  'fi.layer3Current': ' — obecnie {count} istotnych',
  'fi.best': 'Najlepszy',
  'fi.range': 'Rozstęp',
  'fi.interactionDetected': 'Wykryto interakcję: efekt {factorA} zależy od poziomu {factorB}.',
  'fi.noInteraction': 'Brak istotnej interakcji — efekty są w przybliżeniu addytywne.',
