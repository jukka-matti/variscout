...
- Available sub-paths: root (barrel), /stats, /ai, /capability, /parser, /processHub (CharacteristicType, OutcomeSpec, ProcessHub, AnalyzeStatus, etc.), /findings (incl. `findings/drift.ts`), /variation, /tier, /types, /i18n, /glossary, /export, /navigation, /responsive, /performance, /time, /timeline (TimelineWindow + applyWindow), /throughput (computeOutputRate, computeBottleneck), /projectMetadata, /strategy, /ui-types, /evidenceMap, /defect.
