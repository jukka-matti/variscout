...
/**
 * Charter stage Sections renders the existing ImprovementProjectForm.
 * The form already supports per-section props; the IPDetailPage caller controls
 * which props are passed (typically expanding metadata + background + goal for
 * the Charter stage; later PRs add stage-aware expansion).
 */
