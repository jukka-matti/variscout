...
describe('MobileLevelPicker', () => {
  ...
  it('disables Step without a focal step and does not throw when clicked', () => {
    render(<MobileLevelPicker hubId="hub-mobile" currentLevel="l2" />);
    ...
    expect(useCanvasViewportStore.getState().getViewport('hub-mobile').currentLevel).toBe('l2');
  });
