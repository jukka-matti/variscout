...
import { ArrowLeft, Activity, BookOpen, Wrench } from 'lucide-react';
...
export type AdminTab = 'status' | 'knowledge' | 'troubleshooting';
...
function getInitialTab(initialTab?: AdminTab): AdminTab {
  ...
  try {
    ...
    if (stored && ['status', 'knowledge', 'troubleshooting'].includes(stored)) {
      return stored;
    }
  } catch {
    /* ignore */
