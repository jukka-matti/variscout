            ...
            <div key={chipData.factor} className="flex items-center gap-0.5">
              ...
              <button
                ...
                className={`
                  ...
                  transition-colors
                  ${isOpen ? 'bg-blue-500/20 text-blue-300' : 'bg-slate-700/50 text-white hover:bg-slate-700/70'}
                `}
              ...
              <button
                ...
                className="
                  px-1.5 py-1.5 rounded-r-full text-slate-500
                  hover:text-red-400 hover:bg-red-400/10
                  bg-slate-700/50 border-l border-slate-600/50
                  transition-colors
                "
