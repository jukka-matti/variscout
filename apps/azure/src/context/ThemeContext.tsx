...
interface ThemeContextType {
  ...
  /** Whether theming features are enabled (Azure paid product) */
...
/**
 * Theme provider component for the Azure app
 * Manages theme state and applies theme to document.
 * Theming is fully enabled since Azure is the paid product.
 */
export function ThemeProvider({ children }: ThemeProviderProps) {
  ...
  // Theming (theme switching, company accent) is enabled in the Azure paid product
  ...
  }, [resolvedTheme, theme.companyAccent, chartFontScaleValue]);
