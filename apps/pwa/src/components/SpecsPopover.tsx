  ...
  const SpecRow = ({
    ...
    <div className="flex items-center gap-2">
      ...
      <input
        ...
        className={`w-24 bg-surface-tertiary border border-edge-secondary rounded px-2 py-1.5 text-sm text-content text-right outline-none focus:border-blue-500 transition-colors ${
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        <div
          ref={popoverRef}
          className="fixed w-64 bg-surface-secondary border border-edge rounded-lg shadow-2xl z-50 animate-fade-in"
          style={{
            top: position.top,
            left: position.left,
          }}
