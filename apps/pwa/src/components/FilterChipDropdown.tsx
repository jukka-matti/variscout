        ...
        return (
          <button
            ...
            className={`
              ...
              ${isChecked ? 'bg-surface-tertiary/30' : ''}
            `}
          >
            {/* Checkbox */}
            <div
              className={`
                ...
                ${isChecked ? 'bg-blue-500 border-blue-500' : 'border-edge'}
              `}
            >
  ...
  if (isMobile) {
    return (
      <>
        ...
        <div
          ref={dropdownRef}
          className="fixed bottom-0 left-0 right-0 bg-surface-secondary rounded-t-2xl z-50 animate-slide-up"
        >
          {/* Handle */}
          ...
          <div className="px-4 py-3 border-t border-edge bg-surface">
            <div className="flex items-center justify-between text-sm">
              <span className="text-content-secondary">Selected contribution:</span>
  ...
  return (
    <>
      ...
      <div
        ref={dropdownRef}
        style={dropdownStyle}
        className="z-50 bg-surface-secondary border border-edge rounded-lg shadow-xl shadow-black/30 overflow-hidden"
      >
        {/* Header */}
        <div className="flex items-center justify-between px-3 py-2 border-b border-edge">
          ...
          <button
            onClick={onClose}
            className="p-0.5 text-content-secondary hover:text-white rounded transition-colors"
          >
            <X size={14} />
          </button>
        </div>
        ...
        {/* Footer with combined contribution */}
        <div className="px-3 py-2 border-t border-edge bg-surface/50">
