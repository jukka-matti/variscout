...
```mermaid
journey
    title Analyst Alex's Journey
    section Awareness
      Search for variation analysis tool: 3: Alex
      Find VariScout — "variation, not averages": 4: Alex
    section Consideration
      Paste wide-form data into PWA: 5: Alex
      Stack columns auto-detected: 5: Alex
    section Decision
      Boxplot reveals country-level patterns: 5: Alex
      ANOVA confirms what factors matter: 5: Alex
    section Adoption
      Bookmark PWA for recurring datasets: 4: Alex
      Consider Azure for team sharing: 3: Alex
```
