...
| [`suspected-cause-card`](suspected-cause-card.md)           | The redesigned hypothesis card: 3 display states × typed evidence angles × activity layer            | [Analyze/Wall legibility spec](../../superpowers/specs/2026-06-07-analyze-wall-legibility-design.md) §2                        |
| [`causes-matrix`](causes-matrix.md)                         | The cause-verification matrix lens (ADR-086 ACH grid): angles · break attempts · in-flight · verdict | [Analyze/Wall legibility spec](../../superpowers/specs/2026-06-07-analyze-wall-legibility-design.md) §6                        |
| [`control-verification-band`](control-verification-band.md) | The Control storyboard band: phase-split I-Chart plus before/after/now comparison panels             | [Control closure + Report end-state spec](../../superpowers/specs/2026-06-10-control-closure-and-report-endstate-design.md) §6 |
