...
- IMPROVE Phase UX Design — Three-workspace model origin (archived)
- [Improvement Prioritization Design](2026-03-20-improvement-prioritization-design.md) — Timeframe, cost, risk model
- [ADR-024](../../archive/adrs/adr-024-scouting-report.md) — Original scouting report design (superseded)
