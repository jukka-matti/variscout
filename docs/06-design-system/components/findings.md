...
| Generate AI report | All Azure plans | Generates quality engineering report via AI  |
...
The AI report option only appears when `onGenerateAIReport` is provided (injected by the Azure app for all paid plans).
