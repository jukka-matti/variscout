...
Azure App projects are stored in Azure Blob Storage in the customer's resource group. Browser access uses SAS tokens generated by a server-side endpoint:
