...
Every page includes a CTA. Tool and learn pages link to the free PWA for immediate engagement. Pricing and product pages link to the Azure Marketplace (€120/month).
...
- **Schema.org:** `SoftwareApplication` structured data with pricing (Free Web App, €120/month Azure App)
