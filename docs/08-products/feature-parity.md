...
| **Improvement Ideas**             |       ✓        |     ✓      |     ✓      | Brainstorm and evaluate ideas on supported hypotheses. Impact badge from What-If projection, timeframe/cost/risk ratings. Azure: + CoScout ideation coaching. PWA: session-only.                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Improvement Workspace**         |       ✓        |     ✓      |     ✓      | Full-page improvement planning: synthesis card, idea groups by hypothesis, timeframe/cost/risk dropdowns, prioritization matrix, convert to actions. PWA: session-only, teaches the full IMPROVE phase.                                                                                                                                                                                                                                                                                                                                                                                                        |
