...
| **Improvement Ideas**             |       ✓        |     ✓      |     ✓      | Brainstorm and evaluate ideas on supported hypotheses. Impact badge from What-If projection, timeframe/cost/risk ratings. Azure: + CoScout ideation coaching. PWA: session-only (planned).                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Improvement Workspace**         |       ✓        |     ✓      |  Planned   | Full-page improvement planning: synthesis card, idea groups by hypothesis, timeframe/cost/risk dropdowns, prioritization matrix, convert to actions. PWA: session-only, teaches the full IMPROVE phase (planned).                                                                                                                                                                                                                                                                                                                                                                                              |
...
| **Report Workspace**              |       ✓        |     ✓      |  Planned   | Report as a workspace tab (`activeView: 'report'`); report/export/PDF actions live within Report workspace. PWA: session-only report view + copy/PDF (planned). Azure: + Share, Save As.                                                                                                                                                                                                                                                                                                                                                                                                                       |
