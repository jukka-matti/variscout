...
> AI features require customer-deployed Azure AI Foundry resources (optional ARM deployment checkbox). AI is included in the €99 SKU per [ADR-082](../07-decisions/adr-082-wedge-architecture.md). See [ADR-019](../07-decisions/adr-019-ai-integration.md). PWA never has AI.
