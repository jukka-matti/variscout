...
| **Scouting Report (Report View)** |       ✓        |     ✓      |     -      | Story-driven report with 5 steps, chart snapshots per finding, copy-as-slide, Teams deep link sharing. AI prose blocks in Team AI plan.                                                                                                                                      |
