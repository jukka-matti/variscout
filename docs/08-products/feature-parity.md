...
| **Report Workspace**              |       ✓        |     ✓      |     -      | Report as a workspace tab (`activeView: 'report'`); report/export/PDF actions live within Report workspace. Replaces presentation mode overlay.                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
