...
| **↳ What-If with context presets** |       ✓        |     ✓      |     ✓      | What-If Simulator accessible from context panel (cause-scoped presets) and from idea cards (Azure). PWA: via standalone What-If page.                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
