...
| **ProcessHubCurrentStatePanel**      |       ✓        |     ✓      |     -      | Per-state-item display with actions, evidence chip, team notes, generic evidence support. Azure-only (PWA Hub IA pending). PRs #97 / #98 / #99 (Phase 2 V2). See [Actionable Current Process State Panel design](../archive/specs/2026-04-27-actionable-current-process-state-panel-design.md).                                                                                                                                                                                                                                                                                                                |
