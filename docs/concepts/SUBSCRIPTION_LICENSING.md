...
VariScout uses a yearly subscription model (€39/year + VAT) for both the PWA and Excel Add-in. The system uses Paddle for payment processing with hybrid online/offline license validation.

### Key Decisions

| Decision              | Choice                          | Rationale                                  |
| --------------------- | ------------------------------- | ------------------------------------------ |
| **Pricing**           | €39/year + VAT                  | Sustainable revenue, accessible to SMEs    |
...
| **Validation**        | Hybrid (online + offline cache) | Supports offline-first philosophy          |
| **Free Trial**        | None (Community edition)        | Community edition serves as trial          |
| **API Location**      | `apps/pwa/api/`                 | Serverless functions in PWA Vercel project |
| **Database**          | Vercel KV (Upstash Redis)       | Simple key-value storage, Vercel-native    |
...
| **Licensed**  | €39/year | No branding                  | Valid subscription license key |
...
### Location: `apps/pwa/api/`

Vercel serverless functions deployed with the PWA project.
