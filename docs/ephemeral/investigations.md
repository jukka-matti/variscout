...
### C1. LTTB decimation documented-as-shipped but dead — no I-Chart call site ever passed `chartWidth` [LOGGED 2026-06-10]
...
### D2. Auto-X seed: undocumented `slice(0,3)` keyword bias + derived/CSV duplicate factors both selected [LOGGED 2026-06-10]
...
### D3. Findings without a hypothesis have NO Report destination; section checkmarks hardcoded green [LOGGED 2026-06-10]
...
### The Frame/Process → Explore contract — five decisions the Explore spec must state [LOGGED 2026-06-10]
