...
| **[process-operations-layer.md](process-operations-layer.md)** _(2026-06-05)_ | The coherent named-future design of the cadence-review operations layer — cadence model, work-item fields, `stateNotes`, the multi-analyze container, overdue/readiness attention taxonomy — relocated intact before code deletion (PO-1…PO-5, PRs #298–#302). Implementation commit trail included. |
