...
- Interaction Heatmap --- Directly addresses this by showing factor-by-factor interaction strength before drilling.
- Auto-Combination Finder --- The regression engine could surface interaction-driven combinations automatically.
- Factor Map --- Network visualization could show interaction links between factors.
