...
| **Pricing**         | $75/user/month (Creator), $42/user/month (Explorer), $15/user/month (Viewer)  | €150/month (Azure) or free (PWA, Excel)                 |
...
| Price for individual analyst        | $75/month (Creator)                            | Free (PWA) or €150/month (Azure)                                         |
