...
| **Pricing**         | $10/user/month (Pro), $20/user/month (Premium per user), Free (Desktop) | From €120/month (Azure) or free (PWA)                   |
...
| Price for individual analyst | Free (Desktop), $10/month (Pro sharing)           | Free (PWA) or from €120/month (Azure)          |
