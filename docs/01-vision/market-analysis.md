...
**Why €99 is the right number:** sits between the retired €79 Standard and €199 Team, weighted toward Standard. €99/month = €1,188/year is just above the typical €1,000 SME purchasing threshold but acceptable given the V1 product scope (full DMAIC arc, not investigation-only). Honors ADR-033's H6 hypothesis ("per-deployment beats per-seat") — €99 is per-deployment, unlimited org users, unlimited projects.
...
| **TAM (V1 wedge)**            | **~€90–160M/year** | At ~€1,200/year per site (€99/mo)  |
...
- **SMBs with 20–500 employees** — sweet spot for €99/month tenant-wide flat pricing
...
ARR figures revised down from the prior €79 baseline to reflect €99 single-SKU economics (no €199 Team upgrade lever in V1; the upgrade story lives with VariScout Process when it ships).
...
| ------------ | ---------------------- | -------------------- | -------------------------------------------- |
| Minitab      | Per-user, annual       | ~€135–155/user/month | €99/month, unlimited org users (tenant-wide) |
| InfinityQS   | Per-user, subscription | €50–100/user/month   | €99/month, unlimited org users               |
| PQ Systems   | Perpetual license      | ~€595 one-time       | Free PWA + €99/month Azure                   |
| VariScout V1 | Per-Azure-tenant       | €99/month            | —                                            |
...
- **Unlimited org users:** Minitab is per-seat (~€135–155/user/month). VariScout V1 is per-Azure-tenant (€99/month, unlimited org users).
...
| €79→€99 migration churn                 | Revenue dip on transition         | Grandfathering window (see [wedge spec §8.1](../superpowers/specs/2026-05-16-wedge-architecture-design.md)) |
| No €199 upgrade lever in V1             | Lower ARPU until Process ships    | VariScout Process becomes the enterprise expansion product when wedge validates                             |

---

## Bottom Line (V1)

> VariScout V1's TAM is **real but niche** (~€100–200M). The product sits in a genuine gap between expensive per-seat SPC suites and DIY spreadsheet approaches. The €99/month tenant-wide flat pricing keeps the barrier low for SMBs while project membership ACLs scope team access without per-seat billing.
>
> The biggest variable isn't market size — it's **distribution**. Azure Marketplace reach and the free-to-paid funnel (PWA → Azure €99) will determine whether VariScout captures 50 or 5,000 customers.
...
| **TAM (training funnel)**       | **~€5–15M/year** | V1 captures the funnel via the €99 SKU; enterprise training spend defers |

> The PWA continues to drive awareness for V1 specialist upgrades to the €99 plan; the enterprise / multi-org training procurement TAM is a Process expansion lever.
