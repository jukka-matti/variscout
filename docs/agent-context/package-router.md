...
| **PWA-specific (persistence / Dexie)**     | `apps/pwa/CLAUDE.md`                                                           | `packages/stores/CLAUDE.md`                              | ADR-004, ADR-012, ADR-033, ADR-078 | Session-only by default; explicit browser `DocumentSnapshot` save; no cloud sync; no AI in free tier; `@source` directives required                                                                                  | `store-state-glossary` |
