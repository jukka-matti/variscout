...
| **CoScout prompts / AI**                   | `packages/core/CLAUDE.md`                                                      | —                                                        | ADR-057, ADR-060, ADR-068, ADR-069 | `.claude/invariants/coscout-prompts.md`; `assembleCoScoutPrompt()` is entry point; tier 1 is cache-invariant; REF markers not raw data; never "root cause" | —                      |
