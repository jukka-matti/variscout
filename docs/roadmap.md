...
**~~Coherence audit + design~~ — partially superseded 2026-05-16** by the V1 single-SKU pivot. Coherence Session A's 4-persona model retires for V1 (migrates to VariScout Process); Sessions B + C refocus on single-persona V1. Spec [`docs/archive/specs/2026-05-14-variscout-coherence-design.md`](archive/specs/2026-05-14-variscout-coherence-design.md) marked partially superseded; pieces still in force (Session B vocabulary, Session C visual identity + a11y) live in the V1 architecture spec.
