...
| [Investigation Lifecycle Map](workflows/analyze-lifecycle-map.md) | Investigation diamond state diagram for the Investigate phase |
...
| Workflow                                                              | Description                             |
| --------------------------------------------------------------------- | --------------------------------------- |
| [Investigation to Action](workflows/analyze-to-action.md)             | Findings, hypotheses, actions, outcomes |
| [Question-Driven Investigation](workflows/question-driven-analyze.md) | Question tree, validation, evidence     |
| [Investigation Lifecycle Map](workflows/analyze-lifecycle-map.md)     | Diamond state diagrams                  |
