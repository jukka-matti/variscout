...
Generated: 2026-05-28. Source: `scripts/docs/gen-arch.mjs`.
...
| `@variscout/core` | `.`, `./actions`, `./ai`, `./binning`, `./canvas`, `./capability`, `./defect`, `./evidenceMap`, `./evidenceSources`, `./exploreRouting`, `./export`, `./findings`, `./frame`, `./glossary`, `./i18n`, `./identity`, `./improvementProject`, `./matchSummary`, `./measurementPlan`, `./navigation`, `./pareto`, `./parser`, `./performance`, `./persistence`, `./processHub`, `./processMoments`, `./projectMembership`, `./projectMetadata`, `./responsive`, `./signalCards`, `./stats`, `./strategy`, `./survey`, `./tier`, `./time`, `./types`, `./ui-types`, `./variation`, `./yamazumi` | `@variscout/core/binning`, `@variscout/core/exploreRouting`, `@variscout/core/measurementPlan`, `@variscout/core/projectMembership` |
