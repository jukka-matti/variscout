...
Generated: 2026-06-14. Source: `scripts/docs/gen-arch.mjs`.
...
| `@variscout/core` | `.`, `./actions`, `./ai`, `./autoLink`, `./binning`, `./canvas`, `./capability`, `./consultations`, `./defect`, `./evidenceMap`, `./evidenceSources`, `./exploreRouting`, `./export`, `./findings`, `./frame`, `./glossary`, `./i18n`, `./identity`, `./improvementProject`, `./matchSummary`, `./measurementPlan`, `./navigation`, `./pareto`, `./parser`, `./performance`, `./persistence`, `./processHub`, `./processMoments`, `./projectMembership`, `./projectMetadata`, `./responsive`, `./signalCards`, `./stats`, `./strategy`, `./survey`, `./tier`, `./time`, `./types`, `./ui-types`, `./variation` | `@variscout/core/autoLink`, `@variscout/core/binning`, `@variscout/core/consultations`, `@variscout/core/exploreRouting`, `@variscout/core/measurementPlan`, `@variscout/core/projectMembership` |
