...
| 7   | **Boxplot analysis**      | Drill by category factor → verify groups, toggle violin mode, try sorting (name/mean/spread)                               | Visual quality, violin overlay, sort correctness                                         |
