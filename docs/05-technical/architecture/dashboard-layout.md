...
| -------------- | ----- | ----------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- |
| **Stats/Data** | Left  | 280-500px   | 320px   | Stats \| Questions \| Journal \| Docs (4 tabs); Data table and What-If accessible via overflow menu. Histogram/ProbPlot in VerificationCard grid slot. | Drag handle |
