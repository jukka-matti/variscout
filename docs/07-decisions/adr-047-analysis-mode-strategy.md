...
- `questionStrategy` — Implemented ([ADR-054](adr-054-mode-aware-question-strategy.md)). Consumed by question generation pipeline and `QuestionChecklist` evidence badges. Each mode has generator, evidence metric/label, validation method, and question focus.
