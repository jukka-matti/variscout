...
**Tech Stack:** TypeScript, Vitest + React Testing Library + Playwright, Dexie 4, `@azure/storage-blob` SDK (existing), pure-TS engine helpers from `@variscout/core`. No new runtime dependencies.
