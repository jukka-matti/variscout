...
> **Status (2026-05-07):** brainstorm complete; design locked at [`docs/superpowers/specs/2026-05-07-canvas-hypothesis-arrow-drawing-design.md`](../specs/2026-05-07-canvas-hypothesis-arrow-drawing-design.md); 8-task TDD-shaped implementation plan written. **Read the spec for the authoritative design answers** — the master-plan summary below is preserved for orientation but several points have been superseded by the spec (notably Q6: tool placement is top-level + mode-agnostic, NOT mode-2 toolbar; Q7: active-tool state is View, NOT Annotation). Dispatch via `superpowers:subagent-driven-development` per master plan D6.

> **Status (2026-05-07):** brainstorm complete; design locked at [`docs/superpowers/specs/2026-05-07-canvas-hypothesis-arrow-drawing-design.md`](../specs/2026-05-07-canvas-hypothesis-arrow-drawing-design.md). **Read the spec for the authoritative answers** — the master-plan summary below is preserved for orientation but several points have been superseded by the spec (notably Q6: tool placement is top-level + mode-agnostic, NOT mode-2 toolbar; Q7: active-tool state is View, NOT Annotation). Plan-writing is the next session's task per `superpowers:writing-plans`.
