...
D1 says "the action handler reads `existingRange` itself from the most-recent live snapshot — closes the slice 4 follow-up." This is correct for the _persistence handler_ — the handler will query the DB to find `existingRange` before writing.
