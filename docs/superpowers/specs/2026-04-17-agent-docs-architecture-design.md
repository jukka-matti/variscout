...
- [Phase 2: Migration + Switchover](../plans/2026-04-17-agent-docs-architecture-phase2-migration.md) — populate 12 skill bodies, add 6 reference files, atomic swap 9 CLAUDE.mds to live. Old root preserved as `.bak`. `.claude/rules/` still live through Phase 3. **Delivered 2026-04-17.**
- [Phase 3: Enforcement + Cleanup](../plans/2026-04-17-agent-docs-architecture-phase3-enforcement.md) — `eslint-plugin-variscout` with 4 AST rules; 3 pre-commit hooks (ssot, claude-md-size, dead-links); 2 pre-edit advisories; delete `.claude/rules/` (724 lines) + `docs/archive/` (65 files, preserved in `archive-preserved` branch + `archive-snapshot-2026-04-17` tag) + `CLAUDE.md.bak` (181 lines); audit MEMORY.md scope. Always-loaded context target achieved: 905 → 57 lines (93.7% reduction). **Delivered 2026-04-17.**
