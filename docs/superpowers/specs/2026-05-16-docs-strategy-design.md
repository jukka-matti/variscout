...
| 1     | **Play 2b (SSoT discipline by doc type)**             | ~2 days    | ✅ SHIPPED      | Validator forbids `*-amendment-*.md`; enforces `implements:`/`serves:`; decision-log + amendment WARNs; **Apply-phase sensor** (2026-06-02). |
